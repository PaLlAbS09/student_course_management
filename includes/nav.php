    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="search.php">Search & Sort</a></li>
            </ul>
            <ul class="navbar-nav align-items-center">
                <li class="nav-item"><span class="nav-link text-white me-3">Welcome, <?= htmlspecialchars($_SESSION['admin_name'] ?? 'Admin') ?></span></li>
                <li class="nav-item">
                   
                    <a class="btn btn-sm btn-outline-light me-2" href="change_password.php">Change Password</a>
                </li>
                <li class="nav-item">
